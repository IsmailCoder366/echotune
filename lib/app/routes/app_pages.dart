...
import 'package:echotune/splash_screen/splash_screen.dart';
...
class AppPages {
  static final pages = [
    ...
    /// CREATOR FLOW
    GetPage(name: Routes.explore, page: () => ExploreView()),
    //

    //
    // CREATOR FLOW
    GetPage(name: Routes.creatorMainScreen, page: () => CreatorMainScreen()),
    //
    GetPage(name: Routes.uploadMusic, page: () => const MusicUploadView()),
    GetPage(name: Routes.uploadContent, page: () => const ContentUploadView()),
    GetPage(name: Routes.complainScreen, page: () => const ComplainView()),
  ];
}
